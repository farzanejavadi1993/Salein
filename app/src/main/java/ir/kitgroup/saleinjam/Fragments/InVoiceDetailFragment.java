...
import ir.kitgroup.saleinjam.Adapters.InvoiceDetailMobileAdapter;
...
import ir.kitgroup.saleinjam.models.ModelInvoice;
import ir.kitgroup.saleinjam.models.ModelLog;
import ir.kitgroup.saleinjam.R;

import ir.kitgroup.saleinjam.databinding.FragmentInvoiceDetailMobileBinding;
                    ...
                    api.getProduct(company.USER, company.PASS, Guid)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (list1.size() > 0) {
                                        ir.kitgroup.saleinjam.DataBase.Product.saveInTx(list1.get(0));
                    ...
                    if (iDs != null) {
                        ...
                        if (message == 4) {
                            ...
                            for (int i = 0; i < invoiceDetail.size(); i++) {
                                ir.kitgroup.saleinjam.DataBase.Product product = Select.from(ir.kitgroup.saleinjam.DataBase.Product.class).where("I ='" + invoiceDetail.get(i).PRD_UID + "'").first();
                                if (product != null) {
                                    product.delete();
                                }
