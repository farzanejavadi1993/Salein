package ir.kitgroup.saleinOrder.ui.launcher.homeItem;
...
import ir.kitgroup.saleinOrder.models.CustomTab;
import ir.kitgroup.saleinOrder.ui.organization.AccountAdapter;
import ir.kitgroup.saleinOrder.ui.companies.CompanyFragment;
...
import ir.kitgroup.saleinOrder.ui.map.MapFragment;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        myViewModel.getResultSetting().observe(getViewLifecycleOwner(), result -> {
            ...
            if (settingsList.size() > 0) {
                ...
                //region menu
                sharedPreferences.edit().putString("menu", settingsList.get(0).MENU != null ? settingsList.get(0).MENU : "0").apply();
