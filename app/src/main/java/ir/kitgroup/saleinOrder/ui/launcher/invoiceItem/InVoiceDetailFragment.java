package ir.kitgroup.saleinOrder.ui.launcher.invoiceItem;
...
import ir.kitgroup.saleinOrder.ui.launcher.homeItem.MainOrderFragment;
import ir.kitgroup.saleinOrder.ui.payment.PaymentMobileFragment;
import ir.kitgroup.saleinOrder.ui.launcher.homeItem.DescriptionAdapter;
import ir.kitgroup.saleinOrder.Connect.MyViewModel;
...
//           ImageView ivIconSync = dialogSync.findViewById(R.id.iv_icon);
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinOrder.DataBase.Product product = Select.from(ir.kitgroup.saleinOrder.DataBase.Product.class).where("I ='" + invoiceDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
