package ir.kitgroup.saleinhamsafar.ui.payment;
...
import ir.kitgroup.saleinhamsafar.ui.organization.LauncherOrganizationFragment;
...
import ir.kitgroup.saleinhamsafar.databinding.FragmentPaymentMobileBinding;
        ...
        try {
            ...
            btnOk.setOnClickListener(v -> {
                ...
                for (int i = 0; i < invDetails.size(); i++) {
                    ir.kitgroup.saleinhamsafar.DataBase.Product product = Select.from(ir.kitgroup.saleinhamsafar.DataBase.Product.class).where("I ='" + invDetails.get(i).PRD_UID + "'").first();
