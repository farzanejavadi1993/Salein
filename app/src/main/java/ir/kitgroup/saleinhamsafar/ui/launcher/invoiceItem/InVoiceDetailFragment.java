package ir.kitgroup.saleinhamsafar.ui.launcher.invoiceItem;
...
import ir.kitgroup.saleinhamsafar.ui.payment.PaymentMobileFragment;
import ir.kitgroup.saleinhamsafar.ui.launcher.homeItem.DescriptionAdapter;
...
import ir.kitgroup.saleinhamsafar.classes.CustomProgress;
...
import ir.kitgroup.saleinhamsafar.databinding.FragmentInvoiceDetailMobileBinding;
...
//           ImageView ivIconSync = dialogSync.findViewById(R.id.iv_icon);
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinhamsafar.DataBase.Product product = Select.from(ir.kitgroup.saleinhamsafar.DataBase.Product.class).where("I ='" + invoiceDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
...
//                bundleMainOrder.putSerializable("key", (Serializable) invoiceDetailList);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        myViewModel.getResultProduct().observe(getViewLifecycleOwner(), result -> {
            ...
            if (list1.size() > 0) {
                ir.kitgroup.saleinhamsafar.DataBase.Product.saveInTx(list1.get(0));
