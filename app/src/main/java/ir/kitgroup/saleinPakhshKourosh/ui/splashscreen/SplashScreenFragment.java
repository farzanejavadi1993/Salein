package ir.kitgroup.saleinPakhshKourosh.ui.splashscreen;
...
import ir.kitgroup.saleinPakhshKourosh.Connect.MainViewModel;
import ir.kitgroup.saleinPakhshKourosh.DataBase.Account;


import ir.kitgroup.saleinPakhshKourosh.classes.ConnectToServer;
import ir.kitgroup.saleinPakhshKourosh.classes.CustomDialog;
import ir.kitgroup.saleinPakhshKourosh.classes.Util;
import ir.kitgroup.saleinPakhshKourosh.classes.application_information.ApplicationInformation;
import ir.kitgroup.saleinPakhshKourosh.classes.application_information.PackageName;
import ir.kitgroup.saleinPakhshKourosh.databinding.FragmentSplashScreenBinding;
import ir.kitgroup.saleinPakhshKourosh.R;

import ir.kitgroup.saleinPakhshKourosh.classes.HostSelectionInterceptor;

import ir.kitgroup.saleinPakhshKourosh.DataBase.Company;
import ir.kitgroup.saleinPakhshKourosh.DataBase.SaleinShop;
import ir.kitgroup.saleinPakhshKourosh.models.AppDetail;
...
public class SplashScreenFragment extends Fragment {
    ...
    private void initAnimation() {
        try {
            String gif=saleinShop.getGif_url();
            Glide.with(this).asGif().load(Uri.parse(gif)).into(binding.animationView);
