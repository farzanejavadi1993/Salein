...
import ir.kitgroup.saleinorder.classes.RecyclerViewLoadMoreScroll;
...
import ir.kitgroup.saleinorder.DataBase.ProductGroupLevel1;
import ir.kitgroup.saleinorder.DataBase.ProductGroupLevel2;
...
import ir.kitgroup.saleinorder.databinding.OrderFragmentBinding;
...
import static ir.kitgroup.saleinorder.Util.Util.AllProduct;
...
public class OrderFragment extends Fragment implements Filterable {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        textMessageDialog.setText("سفارش با موفقیت ارسال شد");
            ...
            call.enqueue(new Callback<String>() {
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if (remain != -1000000000) {
                        ...
                        if (remain <= 0) {
                            Toast.makeText(getActivity(), "کالا موجودی ندارد", Toast.LENGTH_SHORT).show();
                            if (resultPrd1.size() > 0) {
                                AllProduct.get(AllProduct.indexOf(resultPrd1.get(0))).setAmount(0.0);
                                productAdapter.notifyDataSetChanged();
                            }
                            ...
                            if (!s.equals("")) {
                                ...
                                if (remain - amount < 0) {
                                    ...
                                    if (invoiceDetail != null) {
                                        ...
                                        invoiceDetail.update();
                                        if (resultPrd1.size() > 0) {
                                            AllProduct.get(AllProduct.indexOf(resultPrd1.get(0))).setAmount((double) remain);
                                            productAdapter.notifyDataSetChanged();
                                        }
                                    }
