...
public class ModelProduct {
    ...
    @Expose
    private List<ir.kitgroup.saleinorder.DataBase.Product> ProductList = null;
    ...
    public List<ir.kitgroup.saleinorder.DataBase.Product> getProductList() {
        return ProductList;
    }
    public void setProductList(List<ir.kitgroup.saleinorder.DataBase.Product> productList) {
