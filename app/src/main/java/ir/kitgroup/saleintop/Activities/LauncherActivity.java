...
import ir.kitgroup.saleintop.Fragments.MainFragment;
import ir.kitgroup.saleintop.Fragments.MainOrderMobileFragment;
...
public class LauncherActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        if (refreshApplication) {
            ...
            if (minutes >= 2 && Select.from(User.class).list().size()>0) {
                final int size = getSupportFragmentManager().getBackStackEntryCount();
