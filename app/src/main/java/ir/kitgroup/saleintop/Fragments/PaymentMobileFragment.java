...
import ir.kitgroup.saleintop.Adapters.DateAdapter;
import ir.kitgroup.saleintop.Adapters.OrderTypePaymentAdapter1;
import ir.kitgroup.saleintop.Adapters.TimeAdapter;
...
import ir.kitgroup.saleintop.classes.Utilities;
import ir.kitgroup.saleintop.DataBase.Company;
import ir.kitgroup.saleintop.models.Config;
import ir.kitgroup.saleintop.models.ModelDate;
import ir.kitgroup.saleintop.models.ModelTable;
...
import ir.kitgroup.saleintop.models.ModelTypeOrder;
import ir.kitgroup.saleintop.models.PaymentRecieptDetail;
import ir.kitgroup.saleintop.classes.CustomProgress;
import ir.kitgroup.saleintop.DataBase.Account;
import ir.kitgroup.saleintop.models.Invoice;
import ir.kitgroup.saleintop.DataBase.InvoiceDetail;
import ir.kitgroup.saleintop.models.OrderType;
import ir.kitgroup.saleintop.models.ModelLog;
import ir.kitgroup.saleintop.R;
import ir.kitgroup.saleintop.databinding.FragmentPaymentMobileBinding;
        ...
        try {
            ...
            btnOk.setOnClickListener(v -> {
                ...
                for (int i = 0; i < invDetails.size(); i++) {
                    ir.kitgroup.saleintop.DataBase.Product product = Select.from(ir.kitgroup.saleintop.DataBase.Product.class).where("I ='" + invDetails.get(i).PRD_UID + "'").first();
