...
import ir.kitgroup.saleintop.Adapters.InvoiceDetailMobileAdapter;
...
import ir.kitgroup.saleintop.models.ModelInvoice;
import ir.kitgroup.saleintop.models.ModelLog;
import ir.kitgroup.saleintop.R;

import ir.kitgroup.saleintop.databinding.FragmentInvoiceDetailMobileBinding;
                    ...
                    api.getProduct(company.userName, company.passWord, Guid)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (list1.size() > 0) {
                                        ir.kitgroup.saleintop.DataBase.Product product = Select.from(ir.kitgroup.saleintop.DataBase.Product.class).where("I ='" + list1.get(0).getI() + "'").first();

                                        if (product != null)
                                            product.update();
                                        else
                                            ir.kitgroup.saleintop.DataBase.Product.saveInTx(list1.get(0));
