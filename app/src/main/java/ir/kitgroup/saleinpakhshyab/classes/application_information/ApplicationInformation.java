package ir.kitgroup.saleinpakhshyab.classes.application_information;
    ...
    public SaleinShop getInformation(PackageName packageName , Activity activity) {
        ...
        SaleinShop appInfo = new SaleinShop();
            switch (packageName.getPackageName(activity)) {
                ...
                case "ir.kitgroup.saleinPakhshKourosh":
                    appInfo.setApplication_code("1122");
                    appInfo.setGif_url("splash_screen.json");
                    break;
                case "ir.kitgroup.saleinpakhshyab":
                    appInfo.setApplication_code("1123");
                    appInfo.setGif_url("splash_screen.json");
                    break;
            }
            return appInfo;
