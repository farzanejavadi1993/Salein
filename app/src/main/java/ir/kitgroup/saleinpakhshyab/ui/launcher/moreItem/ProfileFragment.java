package ir.kitgroup.saleinpakhshyab.ui.launcher.moreItem;
...
import ir.kitgroup.saleinpakhshyab.databinding.FragmentProfileBinding;
import ir.kitgroup.saleinpakhshyab.ui.payment.PaymentFragmentDirections;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            if (user.getAdr() != null && !user.getAdr().equals("")) {
                ...
                binding.edit1.setImageResource(R.drawable.ic_plus_new);
                binding.edtAddress1.setTextColor(getActivity().getResources().getColor(R.color.color_accent));
                binding.edtAddress1.setText("افزودن آدرس");
