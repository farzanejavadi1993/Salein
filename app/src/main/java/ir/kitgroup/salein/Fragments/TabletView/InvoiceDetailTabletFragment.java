...
import ir.kitgroup.salein.Adapters.InvoiceDetailTabletAdapter;
...
import ir.kitgroup.salein.databinding.FragmentInvoiceDetailBinding;
...
*/
    ...
    public void ShowData(ArrayList<ir.kitgroup.salein.DataBase.InvoiceDetail> list) {
