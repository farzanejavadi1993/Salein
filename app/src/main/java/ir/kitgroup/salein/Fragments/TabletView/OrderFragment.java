package ir.kitgroup.salein.Fragments.TabletView;
...
import ir.kitgroup.salein.databinding.OrderFragmentBinding;
            ...
            call.enqueue(new Callback<String>() {
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if (iDs == null) {
                        ...
                        List<ir.kitgroup.salein.DataBase.Product> products = iDs.getProductList();
