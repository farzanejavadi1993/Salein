        ...
        try {
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinkonj.DataBase.Product product = Select.from(ir.kitgroup.saleinkonj.DataBase.Product.class).where("I ='" + invoiceDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (iDs.getInvoice().size() == 0) {
                                        ...
                                        if (company.mode == 1) {
                                            Acc_NAME = iDs.getInvoice().get(0).ACC_CLB_NAME;
