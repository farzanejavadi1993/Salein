...
import ir.kitgroup.saleinkonj.Adapters.InvoiceDetailMobileAdapter;
...
import ir.kitgroup.saleinkonj.classes.Utilities;
...
import ir.kitgroup.saleinkonj.models.ModelInvoice;
import ir.kitgroup.saleinkonj.models.ModelLog;
import ir.kitgroup.saleinkonj.R;

import ir.kitgroup.saleinkonj.databinding.FragmentInvoiceDetailMobileBinding;
...
//            }
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinkonj.DataBase.Product product = Select.from(ir.kitgroup.saleinkonj.DataBase.Product.class).where("I ='" + invDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
                ...
                public void onItemRangeRemoved(int positionStart, int itemCount) {
                    ...
                    for (int i = 0; i < invoiceDetailList.size(); i++) {
                        ...
                        ir.kitgroup.saleinkonj.DataBase.Product product = Select.from(ir.kitgroup.saleinkonj.DataBase.Product.class).where("I ='" + invoiceDetailList.get(i).PRD_UID + "'").first();
                        if (product != null) {
                    ...
                    api.getProduct(company.USER, company.PASS, Guid)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (list1.size() > 0) {
                                        ir.kitgroup.saleinkonj.DataBase.Product.saveInTx(list1.get(0));
                    ...
                    if (iDs != null) {
                        ...
                        if (message == 4) {
                            ...
                            for (int i = 0; i < invoiceDetail.size(); i++) {
                                ir.kitgroup.saleinkonj.DataBase.Product product = Select.from(ir.kitgroup.saleinkonj.DataBase.Product.class).where("I ='" + invoiceDetail.get(i).PRD_UID + "'").first();
                                if (product != null) {
                                    product.delete();
                                }
