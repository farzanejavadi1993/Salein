        ...
        //region Tablet Mode
          ...
          /*  invoiceDetailAdapter.editAmountItemListener((GUID, amountString, Price, discountPercent) -> {
            ...
            btnSeenInvoice.setOnClickListener(v -> {
                ...
                ir.kitgroup.salein1order.Fragments.TabletView.InvoiceDetail invoiceDetailFragment = new ir.kitgroup.salein1order.Fragments.TabletView.InvoiceDetail();
...
//        });
    ...
    private static class JsonObject {
        ...
        public List<ir.kitgroup.salein1order.DataBase.InvoiceDetail> InvoiceDetail;
    }
