...
import ir.kitgroup.salein1order.models.ModelInvoice;
...
import ir.kitgroup.salein1order.databinding.FragmentInvoiceDetailMobileBinding;
...
public class InVoiceDetailMobileFragment extends Fragment {
    ...
    private void getInVoice(String userName, String pass, String Inv_GUID) {
        ...
        try {
            ...
            call.enqueue(new Callback<String>() {
                @Override
                public void onResponse(Call<String> call, Response<String> response) { int p = 0;
                    Gson gson = new Gson();
