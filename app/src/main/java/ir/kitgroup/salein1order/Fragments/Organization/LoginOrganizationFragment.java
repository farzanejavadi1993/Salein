...
import ir.kitgroup.salein1order.Connect.API;
...
import ir.kitgroup.salein1order.databinding.FragmentOrganizationLoginBinding;
...
public class LoginOrganizationFragment extends Fragment {
    ...
    private void Login(String userName, String passWord, String ipOrganization, String saleCode) {
      ...
      String  baseUrl = "http://" + LauncherOrganizationFragment.toEnglishNumber(ipOrganization) + "/api/REST/";
