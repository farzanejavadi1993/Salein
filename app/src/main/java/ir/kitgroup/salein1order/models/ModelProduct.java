...
public class ModelProduct {
    ...
    @Expose
    private List<ir.kitgroup.salein1order.DataBase.Product> ProductList = null;
    ...
    public List<ir.kitgroup.salein1order.DataBase.Product> getProductList() {
        return ProductList;
    }
    public void setProductList(List<ir.kitgroup.salein1order.DataBase.Product> productList) {
