...
import ir.kitgroup.saleindemo.classes.dialog.DialogInstance;
...
public class HomeFragment extends Fragment {
    ...
    private final ArrayList<ir.kitgroup.saleindemo.models.Product> productList = new ArrayList<>();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        myViewModel.getResultProductCustomTab().observe(getViewLifecycleOwner(), result -> {
          ...
          //  binding.animationView.setVisibility(View.GONE);
            ...
            ArrayList<ir.kitgroup.saleindemo.models.Product> resultPrd_ = new ArrayList<>(result);
            ArrayList<ir.kitgroup.saleindemo.models.Product> listPrd = new ArrayList<>(resultPrd_);
            ...
            if (listPrd.size() > 0)
                for (int i = 0; i < listPrd.size(); i++) {
                    ...
                    if (resultPrd_.size() > position) {
                        ir.kitgroup.saleindemo.models.Product itemProduct = resultPrd_.get(position);
                        if (index != position) {
