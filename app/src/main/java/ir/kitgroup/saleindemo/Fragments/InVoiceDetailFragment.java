            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onItemRangeRemoved(int positionStart, int itemCount) {
                    ...
                    for (int i = 0; i < invoiceDetailList.size(); i++) {
                        ...
                        ir.kitgroup.saleindemo.DataBase.Product product = Select.from(ir.kitgroup.saleindemo.DataBase.Product.class).where("I ='" + invoiceDetailList.get(i).PRD_UID + "'").first();
                        if (product != null) {
                    ...
                    api.getProduct(company.userName, company.passWord, Guid)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (list1.size() > 0) {
                                        ir.kitgroup.saleindemo.DataBase.Product product = Select.from(ir.kitgroup.saleindemo.DataBase.Product.class).where("I ='" + list1.get(0).getI() + "'").first();
                    ...
                    if (iDs != null) {
                        ...
                        if (message == 4) {
                            ...
                            for (int i = 0; i < invoiceDetail.size(); i++) {
                                ir.kitgroup.saleindemo.DataBase.Product product = Select.from(ir.kitgroup.saleindemo.DataBase.Product.class).where("I ='" + invoiceDetail.get(i).PRD_UID + "'").first();
                                if (product != null) {
                                    product.delete();
                                }
