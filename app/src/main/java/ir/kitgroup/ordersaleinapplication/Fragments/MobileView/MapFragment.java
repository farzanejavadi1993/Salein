...
import ir.kitgroup.ordersaleinapplication.Adapters.SearchViewAdapter;
...
import ir.kitgroup.ordersaleinapplication.databinding.FragmentMapBinding;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.btnRegisterInformation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("address2",binding.edtAddressComplete.getText().toString());
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if (message == 1) {
                        ...
                        if (frg != null){
                            ...
                            if (flag==1)
                                PaymentMobileFragment.doActionEditAddress=true;
                            getFragmentManager().popBackStack();
                            ft.detach(frg);
                            ft.attach(frg);
                            ft.commit();
