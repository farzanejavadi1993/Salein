...
public class ModelProduct {
    ...
    @Expose
    private List<ir.kitgroup.ordersaleinapplication.DataBase.Product> ProductList = null;
    ...
    public List<ir.kitgroup.ordersaleinapplication.DataBase.Product> getProductList() {
        return ProductList;
    }
    public void setProductList(List<ir.kitgroup.ordersaleinapplication.DataBase.Product> productList) {
