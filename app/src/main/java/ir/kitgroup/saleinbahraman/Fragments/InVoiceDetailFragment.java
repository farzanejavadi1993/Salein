...
import ir.kitgroup.saleinbahraman.Adapters.DescriptionAdapter;
import ir.kitgroup.saleinbahraman.Adapters.InvoiceDetailMobileAdapter;
...
import ir.kitgroup.saleinbahraman.classes.CustomProgress;
import ir.kitgroup.saleinbahraman.classes.Util;
import ir.kitgroup.saleinbahraman.classes.Utilities;

import ir.kitgroup.saleinbahraman.DataBase.InvoiceDetail;


import ir.kitgroup.saleinbahraman.DataBase.Company;
import ir.kitgroup.saleinbahraman.models.Description;

import ir.kitgroup.saleinbahraman.models.ModelDesc;

import ir.kitgroup.saleinbahraman.models.ModelInvoice;
import ir.kitgroup.saleinbahraman.models.ModelLog;
import ir.kitgroup.saleinbahraman.R;

import ir.kitgroup.saleinbahraman.databinding.FragmentInvoiceDetailMobileBinding;
import ir.kitgroup.saleinbahraman.models.ModelProduct;
import ir.kitgroup.saleinbahraman.models.Product;
        ...
        try {
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinbahraman.DataBase.Product product = Select.from(ir.kitgroup.saleinbahraman.DataBase.Product.class).where("I ='" + invDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
                ...
                public void onItemRangeRemoved(int positionStart, int itemCount) {
                    ...
                    for (int i = 0; i < invoiceDetailList.size(); i++) {
                        ...
                        ir.kitgroup.saleinbahraman.DataBase.Product product = Select.from(ir.kitgroup.saleinbahraman.DataBase.Product.class).where("I ='" + invoiceDetailList.get(i).PRD_UID + "'").first();
                        if (product != null) {
            ...
            compositeDisposable.add(
                    api.getDescription1(company.USER, company.PASS, id)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                customProgress.hideProgress();
                                Toast.makeText(getActivity(), "خطا در دریافت توضیحات از سرور", Toast.LENGTH_SHORT).show();
                    ...
                    api.getProduct(company.USER, company.PASS, Guid)
                            ...
                            .subscribe(jsonElement -> {
                                ...
                                if (iDs != null) {
                                    ...
                                    if (list1.size() > 0) {
                                        ir.kitgroup.saleinbahraman.DataBase.Product product = Select.from(ir.kitgroup.saleinbahraman.DataBase.Product.class).where("I ='" + list1.get(0).getI() + "'").first();

                                        if (product != null)
                                            product.update();
                                        else
                                            ir.kitgroup.saleinbahraman.DataBase.Product.saveInTx(list1.get(0));
                    ...
                    if (iDs != null) {
                        ...
                        if (message == 4) {
                            ...
                            for (int i = 0; i < invoiceDetail.size(); i++) {
                                ir.kitgroup.saleinbahraman.DataBase.Product product = Select.from(ir.kitgroup.saleinbahraman.DataBase.Product.class).where("I ='" + invoiceDetail.get(i).PRD_UID + "'").first();
                                if (product != null) {
                                    product.delete();
                                }
