...
import ir.kitgroup.saleinbahraman.Adapters.DateAdapter;
import ir.kitgroup.saleinbahraman.Adapters.OrderTypePaymentAdapter1;
import ir.kitgroup.saleinbahraman.Adapters.TimeAdapter;

import ir.kitgroup.saleinbahraman.Connect.API;
import ir.kitgroup.saleinbahraman.DataBase.Product;
...
import ir.kitgroup.saleinbahraman.databinding.FragmentPaymentMobileBinding;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            binding.layoutPaymentOnline.setOnClickListener(v -> {
                ...
                } else if (!company.paymentLink.equals("")) {
    ...
    void SendOrder(List<Invoice> invoice, List<InvoiceDetail> invoiceDetail, List<PaymentRecieptDetail> clsPaymentRecieptDetail) {
        ...
        try {
            ...
            call.enqueue(new Callback<String>() {
                @SuppressLint("SetTextI18n")
                @Override
                public void onResponse(@NotNull Call<String> call, final @NotNull Response<String> response) {
