...
import ir.kitgroup.saleinbahraman.databinding.FragmentOrganizationLoginBinding;
...
public class LoginOrganizationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.btnLogin.setOnClickListener(v -> {
            ...
            Util.PRODUCTION_BASE_URL = "http://" + Util.toEnglishNumber( binding.edtIp1.getText().toString()) + "/api/REST/";
