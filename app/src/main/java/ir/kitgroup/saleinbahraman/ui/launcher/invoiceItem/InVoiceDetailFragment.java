package ir.kitgroup.saleinbahraman.ui.launcher.invoiceItem;
...
import ir.kitgroup.saleinbahraman.ui.launcher.homeItem.MainOrderFragment;
import ir.kitgroup.saleinbahraman.ui.payment.PaymentMobileFragment;
import ir.kitgroup.saleinbahraman.ui.launcher.homeItem.DescriptionAdapter;
...
//           ImageView ivIconSync = dialogSync.findViewById(R.id.iv_icon);
            ...
            invoiceDetailAdapter = new InvoiceDetailAdapter(getActivity(), invoiceDetailList, type, Seen, sharedPreferences);
            ...
            invoiceDetailAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
                ...
                public void onChanged() {
                    ...
                    for (int i = 0; i < invoiceDetails.size(); i++) {
                        ir.kitgroup.saleinbahraman.DataBase.Product product = Select.from(ir.kitgroup.saleinbahraman.DataBase.Product.class).where("I ='" + invoiceDetails.get(i).PRD_UID + "'").first();
                        if (product != null) {
