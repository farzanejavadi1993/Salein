...
public class ModelProduct {
    ...
    @Expose
    private List<ir.kitgroup.order.DataBase.Product> ProductList = null;
    ...
    public List<ir.kitgroup.order.DataBase.Product> getProductList() {
        return ProductList;
    }
    public void setProductList(List<ir.kitgroup.order.DataBase.Product> productList) {
